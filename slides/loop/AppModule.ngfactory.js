    ...
    _View_E2EApp_Host0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        if (!throwOnChange) {
            if ((this.numberOfChecks === 0)) {
                this._E2EApp_0_4.ngAfterViewInit();
            }
        }
    };
...
var _View_E2EApp0 = (function (_super) {
    ...
    _View_E2EApp0.prototype.createInternal = function (rootSelector) {
        ...
        var compView_2 = import76.viewFactory_Slides0(this.viewUtils, this.injector(2), this._appEl_2);
        ...
        var compView_10 = import76.viewFactory_Slides0(this.viewUtils, this.injector(10), this._appEl_10);
        ...
        var disposable_0 = this.renderer.listen(this._el_2, 'ionDidChange', this.eventHandler(this._handle_ionDidChange_2_0.bind(this)));
        this._expr_1 = import71.UNINITIALIZED;
        this._expr_2 = import71.UNINITIALIZED;
        var subscription_0 = this._Slides_2_4.ionDidChange.subscribe(this.eventHandler(this._handle_ionDidChange_2_0.bind(this)));
        this._expr_3 = import71.UNINITIALIZED;
        var disposable_1 = this.renderer.listen(this._el_10, 'ionDidChange', this.eventHandler(this._handle_ionDidChange_10_0.bind(this)));
        this._expr_5 = import71.UNINITIALIZED;
        var subscription_1 = this._Slides_10_4.ionDidChange.subscribe(this.eventHandler(this._handle_ionDidChange_10_0.bind(this)));
    ...
    _View_E2EApp0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import78.TemplateRef) && (4 === requestNodeIndex))) {
            return this._TemplateRef_4_5;
        }
        if (((token === import75.NgFor) && (4 === requestNodeIndex))) {
            return this._NgFor_4_6;
        }
        if (((token === import74.Slides) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 5)))) {
            return this._Slides_2_4;
        }
        if (((token === import78.TemplateRef) && (12 === requestNodeIndex))) {
            return this._TemplateRef_12_5;
        }
        if (((token === import75.NgFor) && (12 === requestNodeIndex))) {
            return this._NgFor_12_6;
        }
        if (((token === import74.Slides) && ((10 <= requestNodeIndex) && (requestNodeIndex <= 13)))) {
    ...
    _View_E2EApp0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var changes = null;
        changed = false;
        var currVal_1 = this.context.myTopSlideOptions;
        ...
        if (((this.numberOfChecks === 0) && !throwOnChange)) {
            this._Slides_2_4.ngOnInit();
        }
        changes = null;
        var currVal_3 = this.context.slides;
    ...
    _View_E2EApp0.prototype._handle_ionDidChange_2_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this.context.onSlideChanged($event) !== false);
        return (true && pd_0);
    };
    _View_E2EApp0.prototype._handle_ionDidChange_10_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this.context.onSlideChanged($event) !== false);
        return (true && pd_0);
    };
...
export function viewFactory_E2EApp0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_E2EApp === null)) {
        (renderType_E2EApp = viewUtils.createRenderComponentType('/Users/joshthomas/Workspace/ionic/test/slides/loop/main.html', 0, import79.ViewEncapsulation.Emulated, styles_E2EApp, {}));
    }
...
var _View_E2EApp1 = (function (_super) {
    ...
    _View_E2EApp1.prototype.createInternal = function (rootSelector) {
        ...
        this._appEl_0 = new import68.AppElement(0, null, this, this._el_0);
        var compView_0 = import76.viewFactory_Slide0(this.viewUtils, this.injector(0), this._appEl_0);
        ...
        this._Slide_0_5 = new import74.Slide(new import77.ElementRef(this._el_0), this.parent._Slides_2_4);
    ...
    _View_E2EApp1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import80.NgClass) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) {
            return this._NgClass_0_4;
        }
        if (((token === import74.Slide) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) {
            return this._Slide_0_5;
        }
        return notFoundResult;
    };
    _View_E2EApp1.prototype.detectChangesInternal = function (throwOnChange) {
        var currVal_0 = this.context.$implicit.class;
    ...
    _View_E2EApp1.prototype.destroyInternal = function () {
...
var _View_E2EApp2 = (function (_super) {
    __extends(_View_E2EApp2, _super);
    function _View_E2EApp2(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_E2EApp2, renderType_E2EApp, import70.ViewType.EMBEDDED, viewUtils, parentInjector, declarationEl, import71.ChangeDetectorStatus.CheckAlways);
    }
    _View_E2EApp2.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.renderer.createElement(null, 'ion-slide', null);
        this._appEl_0 = new import68.AppElement(0, null, this, this._el_0);
        var compView_0 = import76.viewFactory_Slide0(this.viewUtils, this.injector(0), this._appEl_0);
        this._NgClass_0_4 = new import80.NgClass(this.parent.parentInjector.get(import61.IterableDiffers), this.parent.parentInjector.get(import62.KeyValueDiffers), new import77.ElementRef(this._el_0), this.renderer);
        this._Slide_0_5 = new import74.Slide(new import77.ElementRef(this._el_0), this.parent._Slides_10_4);
        this._appEl_0.initComponent(this._Slide_0_5, [], compView_0);
        this._text_1 = this.renderer.createText(null, '', null);
        compView_0.create(this._Slide_0_5, [[].concat([this._text_1])], null);
        this._expr_0 = import71.UNINITIALIZED;
    ...
    _View_E2EApp2.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import80.NgClass) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) {
            return this._NgClass_0_4;
        }
        if (((token === import74.Slide) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) {
    ...
    _View_E2EApp2.prototype.detectChangesInternal = function (throwOnChange) {
        var currVal_0 = this.context.$implicit.class;
        if (import69.checkBinding(throwOnChange, this._expr_0, currVal_0)) {
            this._NgClass_0_4.ngClass = currVal_0;
            this._expr_0 = currVal_0;
    ...
    _View_E2EApp2.prototype.destroyInternal = function () {
        this._Slide_0_5.ngOnDestroy();
    };
    return _View_E2EApp2;
}(import67.AppView));
function viewFactory_E2EApp2(viewUtils, parentInjector, declarationEl) {
