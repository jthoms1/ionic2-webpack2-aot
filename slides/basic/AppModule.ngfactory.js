...
var styles_E2EApp = ['ion-scroll[_ngcontent-%COMP%] {\n  width: 100%;\n  height: 100%;\n}'];
...
var _View_E2EApp0 = (function (_super) {
    ...
    _View_E2EApp0.prototype.createInternal = function (rootSelector) {
        ...
        this._viewQuery_Slides_0 = new import73.QueryList();
    ...
    _View_E2EApp0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import78.TemplateRef) && (2 === requestNodeIndex))) {
            return this._TemplateRef_2_5;
        }
        if (((token === import75.NgFor) && (2 === requestNodeIndex))) {
            return this._NgFor_2_6;
        }
        if (((token === import74.Slides) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) {
    ...
    _View_E2EApp0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var changes = null;
        changed = false;
        var currVal_0 = this.context.mySlideOptions;
        ...
        changes = null;
        var currVal_1 = this.context.images;
...
export function viewFactory_E2EApp0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_E2EApp === null)) {
        (renderType_E2EApp = viewUtils.createRenderComponentType('/Users/joshthomas/Workspace/ionic/test/slides/basic/main.html', 0, import79.ViewEncapsulation.Emulated, styles_E2EApp, {}));
    }
...
var _View_E2EApp1 = (function (_super) {
    ...
    _View_E2EApp1.prototype.createInternal = function (rootSelector) {
        ...
        this._Slide_0_4 = new import74.Slide(new import77.ElementRef(this._el_0), this.parent._Slides_0_4);
    ...
    _View_E2EApp1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import74.Slide) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) {
    ...
    _View_E2EApp1.prototype.detectChangesInternal = function (throwOnChange) {
        this.detectContentChildrenChanges(throwOnChange);
        var currVal_0 = import69.interpolate(1, '', this.parent.context.getImageUrl(this.context.$implicit), '');
        if (import69.checkBinding(throwOnChange, this._expr_0, currVal_0)) {
