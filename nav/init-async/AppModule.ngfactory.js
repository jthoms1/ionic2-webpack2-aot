...
var renderType_AsyncPage_Host = null;
var _View_AsyncPage_Host0 = (function (_super) {
    __extends(_View_AsyncPage_Host0, _super);
    function _View_AsyncPage_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_AsyncPage_Host0, renderType_AsyncPage_Host, import70.ViewType.HOST, viewUtils, parentInjector, declarationEl, import71.ChangeDetectorStatus.CheckAlways);
    }
    _View_AsyncPage_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.selectOrCreateHostElement('ng-component', rootSelector, null);
        this._appEl_0 = new import68.AppElement(0, null, this, this._el_0);
        var compView_0 = viewFactory_AsyncPage0(this.viewUtils, this.injector(0), this._appEl_0);
    ...
    _View_AsyncPage_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import1.AsyncPage) && (0 === requestNodeIndex))) {
            return this._AsyncPage_0_4;
        }
        return notFoundResult;
    };
    return _View_AsyncPage_Host0;
}(import67.AppView));
function viewFactory_AsyncPage_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_AsyncPage_Host === null)) {
        (renderType_AsyncPage_Host = viewUtils.createRenderComponentType('', 0, null, [], {}));
    }
    return new _View_AsyncPage_Host0(viewUtils, parentInjector, declarationEl);
}
export var AsyncPageNgFactory = new import72.ComponentFactory('ng-component', viewFactory_AsyncPage_Host0, import1.AsyncPage);
var styles_AsyncPage = [];
var renderType_AsyncPage = null;
var _View_AsyncPage0 = (function (_super) {
    __extends(_View_AsyncPage0, _super);
    function _View_AsyncPage0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_AsyncPage0, renderType_AsyncPage, import70.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import71.ChangeDetectorStatus.CheckAlways);
    }
    _View_AsyncPage0.prototype.createInternal = function (rootSelector) {
        ...
        var compView_1 = import74.viewFactory_Content0(this.viewUtils, this.injector(1), this._appEl_1);
    ...
    _View_AsyncPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import73.Content) && ((1 <= requestNodeIndex) && (requestNodeIndex <= 2)))) {
            return this._Content_1_4;
        }
        return notFoundResult;
    };
    _View_AsyncPage0.prototype.detectChangesInternal = function (throwOnChange) {
    ...
    _View_AsyncPage0.prototype.destroyInternal = function () {
        this._Content_1_4.ngOnDestroy();
    };
    return _View_AsyncPage0;
}(import67.AppView));
export function viewFactory_AsyncPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_AsyncPage === null)) {
        (renderType_AsyncPage = viewUtils.createRenderComponentType('/Users/joshthomas/Workspace/ionic/test/nav/init-async/AppModule.ts class AsyncPage - inline template', 0, import78.ViewEncapsulation.None, styles_AsyncPage, {}));
    }
...
var _View_E2EApp0 = (function (_super) {
    ...
    _View_E2EApp0.prototype.createInternal = function (rootSelector) {
        ...
        this._appEl_0 = new import68.AppElement(0, null, this, this._el_0);
        var compView_0 = import80.viewFactory_Nav0(this.viewUtils, this.injector(0), this._appEl_0);
    ...
    _View_E2EApp0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import79.Nav) && (0 === requestNodeIndex))) {
...
export function viewFactory_E2EApp0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_E2EApp === null)) {
        (renderType_E2EApp = viewUtils.createRenderComponentType('/Users/joshthomas/Workspace/ionic/test/nav/init-async/AppModule.ts class E2EApp - inline template', 0, import78.ViewEncapsulation.None, styles_E2EApp, {}));
    }
