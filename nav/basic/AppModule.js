...
import { NavController, AlertController, Content, App, IonicModule, NavParams, ViewController } from '../../../dist';
...
export var FirstPage = (function () {
    function FirstPage(navCtrl, view) {
    ...
    FirstPage.prototype.quickPush = function () {
        ...
        this.navCtrl.push(AnotherPage);
        setTimeout(function () {
            _this.navCtrl.push(PrimaryHeaderPage);
        }, 150);
    };
...
export var FullPage = (function () {
    function FullPage(navCtrl, app, alertCtrl, params) {
        this.navCtrl = navCtrl;
        this.app = app;
