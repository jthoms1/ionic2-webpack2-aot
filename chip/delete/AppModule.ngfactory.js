...
var _View_E2EPage0 = (function (_super) {
    ...
    _View_E2EPage0.prototype.createInternal = function (rootSelector) {
        ...
        var compView_34 = import86.viewFactory_Button0(this.viewUtils, this.injector(34), this._appEl_34);
    ...
    _View_E2EPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import76.Label) && ((15 <= requestNodeIndex) && (requestNodeIndex <= 16)))) {
            return this._Label_15_3;
        }
        if (((token === import78.Icon) && (20 === requestNodeIndex))) {
            return this._Icon_20_3;
        }
        if (((token === import77.Button) && ((18 <= requestNodeIndex) && (requestNodeIndex <= 21)))) {
            return this._Button_18_4;
        }
        if (((token === import78.Icon) && (29 === requestNodeIndex))) {
            return this._Icon_29_3;
        }
        if (((token === import76.Label) && ((31 <= requestNodeIndex) && (requestNodeIndex <= 32)))) {
            return this._Label_31_3;
        }
        if (((token === import78.Icon) && (36 === requestNodeIndex))) {
            return this._Icon_36_3;
        }
        if (((token === import77.Button) && ((34 <= requestNodeIndex) && (requestNodeIndex <= 37)))) {
            return this._Button_34_4;
        }
        if (((token === import76.Label) && ((50 <= requestNodeIndex) && (requestNodeIndex <= 51)))) {
            return this._Label_50_3;
        }
        if (((token === import78.Icon) && (55 === requestNodeIndex))) {
            return this._Icon_55_3;
        }
        if (((token === import77.Button) && ((53 <= requestNodeIndex) && (requestNodeIndex <= 56)))) {
    ...
    _View_E2EPage0.prototype._handle_click_18_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this.context.deleteClicked() !== false);
        return (true && pd_0);
    };
...
export function viewFactory_E2EPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_E2EPage === null)) {
        (renderType_E2EPage = viewUtils.createRenderComponentType('/Users/joshthomas/Workspace/ionic/test/chip/delete/main.html', 0, import87.ViewEncapsulation.None, styles_E2EPage, {}));
    }
...
export function viewFactory_E2EApp0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_E2EApp === null)) {
        (renderType_E2EApp = viewUtils.createRenderComponentType('/Users/joshthomas/Workspace/ionic/test/chip/delete/AppModule.ts class E2EApp - inline template', 0, import87.ViewEncapsulation.None, styles_E2EApp, {}));
    }
