...
var _View_E2EPage0 = (function (_super) {
    ...
    _View_E2EPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import76.Icon) && (15 === requestNodeIndex))) {
            return this._Icon_15_3;
        }
        if (((token === import77.Label) && ((17 <= requestNodeIndex) && (requestNodeIndex <= 18)))) {
            return this._Label_17_3;
        }
        if (((token === import76.Icon) && (26 === requestNodeIndex))) {
            return this._Icon_26_3;
        }
        if (((token === import77.Label) && ((28 <= requestNodeIndex) && (requestNodeIndex <= 29)))) {
            return this._Label_28_3;
        }
        if (((token === import76.Icon) && (37 === requestNodeIndex))) {
            return this._Icon_37_3;
        }
        if (((token === import77.Label) && ((39 <= requestNodeIndex) && (requestNodeIndex <= 40)))) {
            return this._Label_39_3;
        }
        if (((token === import76.Icon) && (48 === requestNodeIndex))) {
            return this._Icon_48_3;
        }
        if (((token === import77.Label) && ((50 <= requestNodeIndex) && (requestNodeIndex <= 51)))) {
            return this._Label_50_3;
        }
        if (((token === import76.Icon) && (59 === requestNodeIndex))) {
            return this._Icon_59_3;
        }
        if (((token === import77.Label) && ((61 <= requestNodeIndex) && (requestNodeIndex <= 62)))) {
            return this._Label_61_3;
        }
        if (((token === import76.Icon) && (70 === requestNodeIndex))) {
            return this._Icon_70_3;
        }
        if (((token === import77.Label) && ((72 <= requestNodeIndex) && (requestNodeIndex <= 73)))) {
...
export function viewFactory_E2EPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_E2EPage === null)) {
        (renderType_E2EPage = viewUtils.createRenderComponentType('/Users/joshthomas/Workspace/ionic/test/chip/icon/main.html', 0, import85.ViewEncapsulation.None, styles_E2EPage, {}));
    }
...
export function viewFactory_E2EApp0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_E2EApp === null)) {
        (renderType_E2EApp = viewUtils.createRenderComponentType('/Users/joshthomas/Workspace/ionic/test/chip/icon/AppModule.ts class E2EApp - inline template', 0, import85.ViewEncapsulation.None, styles_E2EApp, {}));
    }
