...
var _View_E2EPage0 = (function (_super) {
    ...
    _View_E2EPage0.prototype.createInternal = function (rootSelector) {
        ...
        var compView_18 = import88.viewFactory_InfiniteScrollContent0(this.viewUtils, this.injector(18), this._appEl_18);
    ...
    _View_E2EPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import77.NgFor) && (13 === requestNodeIndex))) {
            return this._NgFor_13_6;
        }
        if (((token === import76.List) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 14)))) {
            return this._List_11_3;
        }
        if (((token === import79.InfiniteScrollContent) && ((18 <= requestNodeIndex) && (requestNodeIndex <= 19)))) {
            return this._InfiniteScrollContent_18_4;
        }
        if (((token === import78.InfiniteScroll) && ((16 <= requestNodeIndex) && (requestNodeIndex <= 20)))) {
    ...
    _View_E2EPage0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var currVal_6 = 'Loading more data...';
        ...
        var currVal_7 = this._InfiniteScrollContent_18_4.inf.state;
    ...
    _View_E2EPage0.prototype._handle_ionInfinite_16_0 = function ($event) {
...
export function viewFactory_E2EPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_E2EPage === null)) {
        (renderType_E2EPage = viewUtils.createRenderComponentType('/Users/joshthomas/Workspace/ionic/test/infinite-scroll/short-list/main.html', 0, import89.ViewEncapsulation.None, styles_E2EPage, {}));
    }
...
var _View_E2EPage1 = (function (_super) {
    ...
    _View_E2EPage1.prototype.createInternal = function (rootSelector) {
        ...
        this._appEl_0 = new import68.AppElement(0, null, this, this._el_0);
        var compView_0 = import92.viewFactory_Item0(this.viewUtils, this.injector(0), this._appEl_0);
...
export function viewFactory_E2EApp0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_E2EApp === null)) {
        (renderType_E2EApp = viewUtils.createRenderComponentType('/Users/joshthomas/Workspace/ionic/test/infinite-scroll/short-list/AppModule.ts class E2EApp - inline template', 0, import89.ViewEncapsulation.None, styles_E2EApp, {}));
    }
