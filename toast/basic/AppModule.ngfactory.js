...
export function viewFactory_AnotherPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_AnotherPage === null)) {
        (renderType_AnotherPage = viewUtils.createRenderComponentType('/Users/joshthomas/Workspace/ionic/test/toast/basic/AppModule.ts class AnotherPage - inline template', 0, import84.ViewEncapsulation.None, styles_AnotherPage, {}));
    }
...
var _View_E2EPage0 = (function (_super) {
    ...
    _View_E2EPage0.prototype.createInternal = function (rootSelector) {
        ...
        var compView_2 = import78.viewFactory_Navbar0(this.viewUtils, this.injector(2), this._appEl_2);
    ...
    _View_E2EPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import85.Button) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 12)))) {
            return this._Button_11_4;
        }
        if (((token === import85.Button) && ((14 <= requestNodeIndex) && (requestNodeIndex <= 15)))) {
            return this._Button_14_4;
        }
        if (((token === import85.Button) && ((19 <= requestNodeIndex) && (requestNodeIndex <= 20)))) {
            return this._Button_19_4;
        }
        if (((token === import85.Button) && ((22 <= requestNodeIndex) && (requestNodeIndex <= 23)))) {
            return this._Button_22_4;
        }
        if (((token === import85.Button) && ((25 <= requestNodeIndex) && (requestNodeIndex <= 26)))) {
            return this._Button_25_4;
        }
        if (((token === import85.Button) && ((28 <= requestNodeIndex) && (requestNodeIndex <= 29)))) {
            return this._Button_28_4;
        }
        if (((token === import76.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 39)))) {
    ...
    _View_E2EPage0.prototype._handle_click_11_0 = function ($event) {
        ...
        var pd_0 = (this.context.showToast() !== false);
        return (true && pd_0);
    };
    ...
    _View_E2EPage0.prototype._handle_click_22_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this.context.showToastWithCloseButton('bottom') !== false);
        return (true && pd_0);
    };
    _View_E2EPage0.prototype._handle_click_25_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this.context.showToastWithCloseButton('top') !== false);
        return (true && pd_0);
    };
    _View_E2EPage0.prototype._handle_click_28_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this.context.showToastWithCloseButton('middle') !== false);
        return (true && pd_0);
    };
...
export function viewFactory_E2EPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_E2EPage === null)) {
        (renderType_E2EPage = viewUtils.createRenderComponentType('/Users/joshthomas/Workspace/ionic/test/toast/basic/main.html', 0, import84.ViewEncapsulation.None, styles_E2EPage, {}));
    }
...
export function viewFactory_E2EApp0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_E2EApp === null)) {
        (renderType_E2EApp = viewUtils.createRenderComponentType('/Users/joshthomas/Workspace/ionic/test/toast/basic/AppModule.ts class E2EApp - inline template', 0, import84.ViewEncapsulation.None, styles_E2EApp, {}));
    }
