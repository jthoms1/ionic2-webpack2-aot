...
var styles_E2EPage = ['ion-avatar[_ngcontent-%COMP%] img[_ngcontent-%COMP%] {\n    width: 80px !important;\n    height: 80px;\n  }\n  img[_ngcontent-%COMP%] {\n    height: 100px;\n  }'];
...
var _View_E2EPage0 = (function (_super) {
    ...
    _View_E2EPage0.prototype.createInternal = function (rootSelector) {
        ...
        var compView_30 = import85.viewFactory_Item0(this.viewUtils, this.injector(30), this._appEl_30);
    ...
    _View_E2EPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import76.ItemContent) && ((30 <= requestNodeIndex) && (requestNodeIndex <= 42)))) {
            return this._ItemContent_30_4;
        }
        if (((token === import76.Item) && ((30 <= requestNodeIndex) && (requestNodeIndex <= 42)))) {
            return this._Item_30_5;
        }
        if (((token === import75.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 46)))) {
...
export function viewFactory_E2EPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_E2EPage === null)) {
        (renderType_E2EPage = viewUtils.createRenderComponentType('/Users/joshthomas/Workspace/ionic/test/card/images/main.html', 0, import86.ViewEncapsulation.Emulated, styles_E2EPage, {}));
    }
...
export function viewFactory_E2EApp0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_E2EApp === null)) {
        (renderType_E2EApp = viewUtils.createRenderComponentType('/Users/joshthomas/Workspace/ionic/test/card/images/AppModule.ts class E2EApp - inline template', 0, import86.ViewEncapsulation.None, styles_E2EApp, {}));
    }
