...
var _View_E2EPage0 = (function (_super) {
    ...
    _View_E2EPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import84.TemplateRef) && (11 === requestNodeIndex))) {
            return this._TemplateRef_11_5;
        }
        if (((token === import76.NgFor) && (11 === requestNodeIndex))) {
            return this._NgFor_11_6;
        }
        if (((token === import75.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 12)))) {
    ...
    _View_E2EPage0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        changes = null;
        var currVal_2 = this.context.people;
...
export function viewFactory_E2EPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_E2EPage === null)) {
        (renderType_E2EPage = viewUtils.createRenderComponentType('/Users/joshthomas/Workspace/ionic/test/list/repeat-headers/main.html', 0, import85.ViewEncapsulation.None, styles_E2EPage, {}));
    }
...
var _View_E2EPage1 = (function (_super) {
    ...
    _View_E2EPage1.prototype.createInternal = function (rootSelector) {
        ...
        this._appEl_2 = new import68.AppElement(2, 0, this, this._el_2);
        var compView_2 = import89.viewFactory_Item0(this.viewUtils, this.injector(2), this._appEl_2);
        ...
        this._query_Label_2_0 = new import88.QueryList();
        this._query_Button_2_1 = new import88.QueryList();
        this._query_Icon_2_2 = new import88.QueryList();
    ...
    _View_E2EPage1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import86.ListHeader) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 3)))) {
            return this._ListHeader_2_4;
        }
        if (((token === import87.Item) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 3)))) {
            return this._Item_2_5;
        }
        if (((token === import84.TemplateRef) && (5 === requestNodeIndex))) {
            return this._TemplateRef_5_5;
        }
        if (((token === import76.NgFor) && (5 === requestNodeIndex))) {
            return this._NgFor_5_6;
        }
        if (((token === import86.List) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 6)))) {
    ...
    _View_E2EPage1.prototype.detectChangesInternal = function (throwOnChange) {
        var changes = null;
        changes = null;
        var currVal_1 = this.context.$implicit.components;
        if (import69.checkBinding(throwOnChange, this._expr_1, currVal_1)) {
...
var _View_E2EPage2 = (function (_super) {
    ...
    _View_E2EPage2.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import90.Icon) && (4 === requestNodeIndex))) {
            return this._Icon_4_3;
        }
        if (((token === import87.ItemContent) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 6)))) {
            return this._ItemContent_0_4;
        }
        if (((token === import87.Item) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 6)))) {
...
export function viewFactory_E2EApp0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_E2EApp === null)) {
        (renderType_E2EApp = viewUtils.createRenderComponentType('/Users/joshthomas/Workspace/ionic/test/list/repeat-headers/AppModule.ts class E2EApp - inline template', 0, import85.ViewEncapsulation.None, styles_E2EApp, {}));
    }
