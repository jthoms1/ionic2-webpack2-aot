...
var _View_E2EApp0 = (function (_super) {
    ...
    _View_E2EApp0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import76.Icon) && (43 === requestNodeIndex))) {
            return this._Icon_43_3;
        }
        if (((token === import75.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 45)))) {
...
export function viewFactory_E2EApp0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_E2EApp === null)) {
        (renderType_E2EApp = viewUtils.createRenderComponentType('/Users/joshthomas/Workspace/ionic/test/app/typography/main.html', 0, import84.ViewEncapsulation.None, styles_E2EApp, {}));
    }
