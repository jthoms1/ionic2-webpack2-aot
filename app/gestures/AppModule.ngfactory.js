...
var _View_E2EPage0 = (function (_super) {
    ...
    _View_E2EPage0.prototype.createInternal = function (rootSelector) {
        ...
        var disposable_0 = this.renderer.listen(this._el_11, 'tap', this.eventHandler(this._handle_tap_11_0.bind(this)));
        this.init([], [
            this._el_0,
            this._text_1,
            this._el_2,
    ...
    _View_E2EPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import76.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 13)))) {
    ...
    _View_E2EPage0.prototype._handle_tap_11_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this.context.onTap($event) !== false);
        return (true && pd_0);
    };
...
export function viewFactory_E2EPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_E2EPage === null)) {
        (renderType_E2EPage = viewUtils.createRenderComponentType('/Users/joshthomas/Workspace/ionic/test/app/gestures/main.html', 0, import86.ViewEncapsulation.None, styles_E2EPage, {}));
    }
...
export function viewFactory_E2EApp0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_E2EApp === null)) {
        (renderType_E2EApp = viewUtils.createRenderComponentType('/Users/joshthomas/Workspace/ionic/test/app/gestures/AppModule.ts class E2EApp - inline template', 0, import86.ViewEncapsulation.None, styles_E2EApp, {}));
    }
