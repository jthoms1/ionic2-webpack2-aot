...
export var SessionList = (function () {
    ...
    /** @nocollapse */
    SessionList.decorators = [
        { type: Component, args: [{
                    templateUrl: 'session-list.html'
                },] },
    ];
    /** @nocollapse */
    SessionList.ctorParameters = [
        { type: NavController, },
    ];
    return SessionList;
}());
